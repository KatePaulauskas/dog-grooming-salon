...
The live site can be found at the following [address](https://barks-in-bubbles-a17d3839532d.herokuapp.com/).
...
* **New Pet Owners:** Individuals who have recently acquired a dog or a puppy and are in need of reliable grooming services in the Cork area to introduce the dog to grooming.

* **Returning Pet Owners:** Customers looking for a consistent and reliable dog grooming provider in the Cork area to use on a regular basis.
...
* **Dog Training Services:** Training providers around the Cork area seeking grooming services for their clients' dogs as part of a complete care package.
...
A new user can easily navigate through the website with a clear introduction and an intuitive menu. They can learn about the salon's mission, view the services offered, explore groomer profiles, and see a gallery of grooming work. They can also create an account and book their first grooming appointment with ease.
...
- As a Site Owner, I can store contact form requests in the database so that I can review them, mark them as read, or delete them.

- As a Site Owner, I can mark contact form submissions as "read" so that I can track how many I still need to process.

**Epic 4: Account Management**

***User Stories:***

- As a Site User, I can create an account through the Log-In bar so that I can access personalised services to book and store my appointments.
...
* Provides links to make a booking
...
* It includes a step-by-step booking process, guiding users through selecting services, picking a date, choosing a groomer, and selecting a time.
...
* Facilitates appointment management tracking.
...
Time slots are generated every 2 hours, accounting for each service duration of 1 hour and 30 minutes, with a 30-minute buffer time at the end of each appointment, accounting for breaks, running over time, and cleaning at the end of the day. 
...
The initial layout of the interface and navigation of the Bark in Bubbles website was developed using Balsamiq Studios software, through which a mockup wireframes were created for the main pages.
...
### Surface
On the Surface Plane the visual design of the site was developed, with more focus given to the look and feel of the site.

#### Colour Scheme

The colours for the Barks in Bubbles site were carefully selected using [Coolors tool](https://coolors.co/) to create an inviting, professional, and engaging atmosphere. 

![Colour Scheme](media/barks-in-bubbles-color-pallet.png)

The chosen colour palette, set against a white background, combines freshness, warmth, tranquilly, playfulness, and sophistication to create a balanced and appealing environment. Each colour plays a specific role in enhancing the customer experience:
...
- The white background ensures that these colours stand out beautifully, contributing to an inviting, professional, and engaging atmosphere that appeals to both pets and their owners. 

Below is a detailed breakdown of the colour choices and the reasoning behind them:

**Mantis (#5ecc5c):**

Mantis is a vibrant green colour that exudes a sense of freshness and vitality. This colour was chosen to evoke feelings of nature, growth, and renewal, which are associated with health and well-being. It represents the care and rejuvenation that pets will experience at the grooming salon. Green is also known for its calming effects, making it a good choice for both pets and their owners.

**UT Orange (#fe8b32):**

UT Orange is a bright, warm orange colour that captures attention and adds a touch of energy. Orange is often associated with enthusiasm, creativity, and warmth. This colour was selected to create a welcoming and energetic atmosphere in the salon. It can help to make the environment feel friendly and inviting, encouraging customers to feel excited about bringing their pets for grooming services.

**Robin Egg Blue (#14cfdb):**

Robin Egg Blue is a light and refreshing blue colour reminiscent of clear skies and calm waters. This colour was chosen to convey tranquility, trust, and reliability. Blue is known to have a soothing effect, which is beneficial in a setting where pets may be anxious. It also gives a sense of cleanliness and professionalism, reassuring clients of the high standards of hygiene and care in the salon.

**Hot Pink (#ff5cb7):**

Hot Pink is a bold and playful pink colour that adds a fun and energetic vibe. Pink is often associated with compassion, nurturing, and love. The vibrant shade of hot pink was chosen to inject a sense of playfulness and joy into the salon's environment. It reflects the affectionate and caring nature of the services provided, making the space feel lively and engaging.

**English Violet (#3f3850):**

English Violet is a deep, rich violet colour that adds depth and sophistication. Violet is traditionally associated with luxury, wisdom, and dignity. This colour was chosen to convey a sense of premium quality and elegance. It adds a touch of sophistication to the salon's aesthetic, appealing to clients who value high-quality services and a refined atmosphere.

**White Background (#ffffff):**

The primary background colour used throughout the design is white. White is the perfect canvas for highlighting the vibrant and diverse colour palette. It provides a clean, crisp, and professional look that enhances readability and ensures that the bright colours stand out without overwhelming the viewer. White backgrounds help create a sense of openness and space, making the salon feel more inviting and less cluttered. It also reinforces the notions of cleanliness and simplicity, which are essential qualities for a grooming salon. 

The combination of these colours ensures that the salon not only stands out visually but also conveys the values and quality of the services provided.

#### Typography

The fonts for the site were carefully selected using the font pairing service [Font Joy](https://fontjoy.com/) to create a visually appealing and cohesive design. Each font was chosen to enhance the user experience and align with the brand's identity. 
...
The header contains the navigation bar, logo, and 'Log In' and 'Book Now' buttons. The navigation bar is positioned on the left, while the logo is prominently displayed in the centre, ensuring brand recognition. The logo features a drawing of a happy dog in colourful bubbles and foam, representing the brand and providing a clear visual hint about the site's focus on dog grooming.
...
Clicking on it reveals a drop-down menu showcasing the current page highlighted and underlined to ensure smooth navigation. The menu items are displayed on a full-width background, creating a cohesive block with the header.

The notification informing the user whether they are logged in or not is displayed in the drop-down menu. The 'Log In' and 'Book Now' buttons are positioned vertically to ensure the limited screen space is utilised efficiently.
...
If a user does not follow the recommendations for creating secure credentials, notifications appear in a bright colour to draw their attention to the issue with the credentials to assist with fixing.
...
* If a customer already has scheduled appointments, they see the list of their appointments as well as the 'Book New Appointment' buttons:

![All Bookings Page - User Has Appointments](/media/all-bookings-page-user-has-appointments.jpeg)

* The superuser sees all the appointments that are scheduled on the All Bookings' Page, and additionally, they have a username displayed for each booked appointment:

![All Bookings Superuser View](/media/all-bookings-superuser-view.jpeg)

Users who have scheduled appointments have the option to edit or delete their future bookings. As well, the superuser can schedule or delete appointments on the customer's behalf. The edit and delete options are greyed out for any past bookings.
...
This form allows users to select services:
...
In the second step of the booking form, users are presented with a drop-down menu to select a groomer:
...
In Step Three of the booking process, customers or superuser must select a timeslot. The first available timeslot for the selected date and groomer is preloaded in the drop-down menu:
...
Upon clicling 'Cancel' button during the booking process at any stage, when customer is taken to the 'All Bookings' page, they are presented with a notification: 'Action cancelled. No changes were saved.'

![Booking Process Cancelled](/media/action-cancelled-booking-form.jpeg)
...
![Book Appointment: The User Has Not Logged In](/media/book-appointment-user-not-logged-in.jpeg)

**Editing and Deleting appointents**

On the All Bookings page, which is accessible only to logged-in users, there are options to edit and delete future appointments (up to 24 hours before the appointment time). For past appointments, this functionality is not available and is therefore greyed out.

**- Edit Appointment**

Upon clicking the 'Edit' button next to a future appointment, customers or superusers are redirected to the first step of the booking process. The page has the heading 'Edit Appointment,' and the service and date fields are pre-filled. Users can change the service and date via drop-down menus, and they have the option to cancel the editing or proceed to the second step.

![Edit Appointment Step One](/media/edit-appointment-step-one.jpeg)
...
![Edit Appointment Step Two](/media/edit-appointment-step-two.jpeg)

The cancel button cancels the editing process; the prev step button takes you back to step one; the deltails are prefilled; and the nest step button takes you to step three. 

In the third step, based on the date and selected groomer, the first available timeslot is pre-filled. By clicking on the dropdown, users can view and select from other available timeslots. Timeslots are generated using the same approach as in the initial booking process. Also, similar to the initial booking process, there is a 'Cancel' button that cancels the editing, a 'Prev Step' button that takes users back to the second step with the groomer's name pre-filled, and a 'Submit' button that updates the appointment based on the edits introduced:

![Edit Appointment Step Three](/media/edit-appointment-step-three.jpeg)

Upon clicling 'Cancel' button during the editing process at any stage, they are presented with a notification: 'Action cancelled. No changes were saved.'

![Booking Process Cancelled](/media/action-cancelled-booking-form.jpeg)

 After submitting edited appointment, customers or superusers are taken to the All Bookings page, where they are presented with the notification: 'Appointment has been updated!' The updated appointment is displayed in the All Bookings table in chronological order with other appointments:

 ![Edit Appointment - Confirmation Message](/media/edit-appointment-confirmation.jpeg)
...
By selecting a specific appointment, the superuser can fully edit it, change its status, save it, or delete it:
...
2. Enable Superuser to select or add a new customer through the front end.
3. Implement email notifications for when an appointment is booked, rescheduled, or deleted.
4. Offer services with different durations and adjust the booking flow accordingly.
5. Implement functionality to ensure certain services are performed only by specific groomers.
6. Add a notes field for the superuser to be able to add comments to appointments.
7. Provide more tailored services, taking into consideration the dog’s breed and size.
...
* **Django Summernote (version 0.8.20.0):** Allows adding rich text editing capabilities, enabling dynamic content management through the admin panel.
...
* **Cloudinary (version 1.40.0):** Provides a solution for hosting and managing static and media files, optimising content delivery.
...
| On the Gallery page click on the tab 'PREV' | Previous 8 images load | Pass |
| On the Gallery page click on the tab 'NEXT' | Next 8 images load | Pass |
| Click on the Contact Page link | Contact Page loads | Pass |
| Click on the hamburger menu icon on the mobile or tablet device | Menu items expand inside the header in a dropdown | Pass |
| Hamburger menu icon on larger screens | Hidden | Pass |
 Click on the logo | Home page loads | Pass |
| Header buttons were tested on all pages of the site on mobile, tablet, and desktop |  |  |
...
| Form was tested on on mobile, tablet, and desktop devices in multiple browsers |  |  |
...
| Action/Feature          | Expected Behavior       | Status         |
|-------------------------|-------------------------|----------------|
| Click on the Book Now button in the header of the site while logged out | The user is taken to a separate page where the message "Log in here to book your appointment" is displayed | Pass |
| Click on the Book Now button at the top / bottom of the Home page while logged out | In both cases, the user is taken to a separate page where the message "Log in here to book your appointment" is displayed | Pass |
| Click on the Book Now button at the top / bottom of the Groomers page while logged out | The user is taken to a separate page where the message "Log in here to book your appointment" is displayed | Pass |
| Click on the Book Now button at the top / bottom of the Gallery page while logged out | User is taken to a separate page where the message "Log in here to book your appointment" is displayed | Pass |
...
| Enter only the username and click Log In | Error message "Please fill in this field" is displayed next to the password field | Pass |
| Enter only the password and click Log In | Error message "Please fill in this field" is displayed next to the username field | Pass |
...
| Enter only the username and click Sing Up | Error message "Please fill in this field" is displayed next to the password field | Pass |
 Enter only the password and click Sing Up | Error message "Please fill in this field" is displayed next to the username field | Pass |
...
| Enter username, a password, and a password (again) that is less than 8 characters and click Sign Up | Error message "This password is too short. It must contain at least 8 characters." is displayed | Pass |
| Enter username, password, and password (again), use a common password, and click Sign Up | Error message "This password is too common." is displayed | Pass |
| Enter username, password, and password (again), use a numeric password, and click Sign Up | Error message "This password is entirely numeric." is displayed | Pass |
| Enter username, password, and password (again), use a password similar to personal information and click Sign Up | Error message "Your password can’t be too similar to your other personal information." is displayed | Pass |
| Enter username, password, and password (again), use different passwords for password and password (again), and click Sign Up | Error message "You must type the same password each time." is displayed | Pass |
| Fill out all fields correctly: enter username, password, and password (again), use the same passwords; if adding email, add email that was not previously registered; and click Sign Up | User is redirected to the appointment booking page | Pass |
...
| Action/Feature          | Expected Behavior       | Status         |
|-------------------------|-------------------------|----------------|
| Click on any 'Book Now' button while logged out | The user is redirected to the login page with the message  "Log in here to book your appointment" | Pass |
| Click on any 'Book Now' button while logged in | The user is redirected to the booking appointment form. Step one of the booking form loads with options to select service and date. Options to 'Cancel' or move to the 'Next Step' available | Pass |
In  step one, click on the 'Cancel' option | A booking is cancelled, the user is directed to the All Bookings Page. Message displayed: 'Action cancelled. No changes were saved.' | Pass |
| Click on the 'Next Step' button in step one | A notification 'Please select an item in the list' appears in the Services dropdown list | Pass |
| Select Service from the drop-down list and click on the 'Next Step' button in step one | 'Please fill in this field' appears in the Date drop-down | Pass |
| Select Service from the dropdown list and select a past date in step one, then click 'Next Step' | Error message "Not possible to select date in the past" is displayed | Pass |
| Select Service from the dropdown list and select a date more than 90 days ahead in step one and click 'Next Step' | Error message "Not possible to select a date more than 90 days in advance" is displayed | Pass |
| Book an appointment for today after salon closing hours (after 5:30 p.m. on a weekday or after 4 p.m. on a weekend). Select Service from the drop-down list, select today's date in step one, and click 'Next Step' | Error message "Not possible to book for today as the salon is already closed" is displayed | Pass |
| Select Service from the drop-down list, select a date within the next 90 days, and click 'Next Step' | Step two of the booking form loads with options to select a groomer. Options to go to the 'Prev Step', 'Next Step', or 'Cancel' are available | Pass |
| Click on 'Prev Step' in Step two | 'Please select an item in the list' appears in the Groomers drop-down list. After selecting a groomer, and clicking on 'Prev Step' again, the user is directed back to step one with previously entered service and date details retained | Pass |
| Click on 'Cancel' in Step Two | The booking process is cancelled, user is directed to the 'All Bookings' page. Message displayed: 'Action cancelled. No changes were saved.' | Pass |
| Click on 'Next Step' in Step two | 'Please select an item in the list' appears in the Groomers dropdown list | Pass |
| Select a groomer in step two and click 'Next Step' | Step three of the booking form loads with available time slots. Options to go to the 'Prev Step', 'Cancel', or 'Submit' are available | Pass |
| Click 'Prev Step' in step three | The user is directed back to step two with the previously selected groomer retained | Pass |
| Click 'Cancel' in step three | The booking process is cancelled, user is directed to the 'All Bookings' page. Message displayed: 'Action cancelled. No changes were saved.' | Pass |
| In step three, select a time slot and click 'Submit' | The appointment is successfully booked, the user is directed to the 'All Bookings' page with a confirmation message: "Thank you for booking your appointment!" | Pass |
...
|**Testign Edit & Delete Functionality for future appointments less than 24 hours before the appointment time** |
| Try to click the Edit or Delete button for a future appointment less than 24 hours before the appointment time | Editing or deleting options are not available, as they are grayed out | Pass |
|**Testign Edit & Delete Functionality for past appointments** |
| Try to edit any past bookings, before today's date | Editing option for older bookings is greyed out | Pass |
| Try to delete any past bookings, before today's date | Delete options for older bookings are greyed out | Pass |
|**Testing the editing and delete features on appointments that start more than 24 hours from the current time**|
|**Testign Edit Functionality** |
| Click on Edit next to any future appointment | Step one of the booking form loads with the prefilled details of the appointment. The service and date can be changed from the dropdown. Options to 'Cancel' or move to the 'Next Step' available | Pass |
| Click on Edit next to any future appointment. Step one of the booking form loads with the prefilled details of the appointment. Service and date can be changed from the dropdown. Click on the 'Cancel' option | Editing is cancelled, the user is directed to the All Bookings Page. Message displayed: 'Action cancelled. No changes were saved.' | Pass |
| After 5:30 p.m. on a weekday or after 4 p.m. on a weekend, click on Edit next to any future appointment. Step one of the booking form loads with the prefilled details of the appointment. In step one, change'service' and 'date', and select today's date. | Error message "Not possible to book for today as the salon is already closed" is displayed    | Pass |
| Click on Edit next to any future appointment. Step one of the booking form loads with the prefilled details of the appointment. In step one, change'service' and 'date', and choose a past date | Error message "Not possible to select date in the past" is displayed | Pass |
...
| Click on Edit next to any future appointment. Step one of the booking form loads with the prefilled details of the appointment. In step one, change 'service' and 'date', select a date within the next 90 days, then click 'Next Step' | Step two of the booking form loads with the prefilled groomer name (if available on that date, or the dropdown is blank). The groomer name can be changed from the dropdown. Options to go to the 'Prev Step', 'Next Step', or 'Cancel' are available | Pass |
| Click on Edit next to any future appointment. Step one of the booking form loads with the prefilled details of the appointment. In step one, change 'service' and 'date', select a date within the next 90 days, and then click 'Next Step'. Step two of the booking form loads with the prefilled groomer name (if available on that date, or the dropdown is blank). Click on 'Prev step' in Step two | User is directed back to Step one with the previously entered service and date details retained, if groomer name is selected, otherwise, the user needs to select the groomer to be able to go to the previous step | Pass |
| Click on Edit next to any future appointment. Step one of the booking form loads with the prefilled details of the appointment. In step one, change 'service' and 'date', select a date within the next 90 days, and then click 'Next Step'. Step two of the booking form loads with the prefilled groomer name (if available on that date, or the dropdown is blank). Click on 'Cancel' in Step Two | Editing is cancelled, user is directed to the All Bookings Page. Message displayed: 'Action cancelled. No changes were saved.' | Pass |
| Click on Edit next to any future appointment. Step one of the booking form loads with the prefilled details of the appointment. In step one, change 'service' and 'date', select a date within the next 90 days, and then click 'Next Step'. Step two of the booking form loads with the prefilled groomer name (if available on that date, or the dropdown is blank). Change/select groomer. Click on 'Next Step' in Step two | Step three of the booking form loads the available time slots. Options to go to the 'Prev step', 'Cancel', or 'Submit' are available | Pass |
| Click on Edit next to any future appointment. Step one of the booking form loads with the prefilled details of the appointment. In step one, change 'service' and 'date', select a date within the next 90 days, and then click 'Next Step'. Step two of the booking form loads with the prefilled groomer name (if available on that date, or the dropdown is blank). Change/select groomer. Click on 'Next Step' in Step two. Step three of the booking form loads with the available time slots. Click on 'Prev step' in Step three | User is directed back to Step two with the previously entered groomer name retained  | Pass |
| Click on Edit next to any future appointment. Step one of the booking form loads with the prefilled details of the appointment. In step one, change 'service' and 'date', select a date within the next 90 days, and then click 'Next Step'. Step two of the booking form loads with the prefilled groomer name (if available on that date, or the dropdown is blank). Change/select groomer. Click on 'Next Step' in Step two. Step three of the booking form loads the available time slots. Click on 'Cancel' in Step Three | Editing is cancelled, user is directed to the All Bookings Page. Message displayed: 'Action cancelled. No changes were saved.' | Pass |
| Click on Edit next to any future appointment. Step one of the booking form loads with the prefilled details of the appointment. In step one, change 'service' and 'date', select a date within the next 90 days, and then click 'Next Step'. Step two of the booking form loads with the prefilled groomer name (if available on that date, or the dropdown is blank). Change/select groomer. Click on 'Next Step' in Step Two. Step three of the booking form loads with the available time slots. Select a time slot in Step three from the dropdown or keep the offered time slot, click 'Submit' | Appointment is successfully updated, user is directed to the 'All Bookings' Page with a confirmation message: 'Thank you for booking your appointment!' | Pass |
|**Testign Delete Functionality** |
...
| Click on 'Delete' next to any future appointment; in the pop-up window, click the 'Delete' button | The appointment is deleted, and the user is redirected to the 'All Bookings' page with a confirmation message: 'Appointment deleted!'| Pass |
| Click on 'Delete' next to any future appointment; in the pop-up window, click the 'Close' button | The pop-up window is closed, and no changes are made to the appointment | Pass |

**Superuser Actions/Features**
| Action/Feature | Expected Behavior | Status |
|----------------|-------------------|--------|
| **Frontend**|
| Log in as Superuser | Superuser can see a list of all bookings made on the All Bookings Page | Pass |
| Edit booking details | Superuser can edit any existing future booking and change service, date, groomer and time | Pass |
| Delete booking | Superuser can delete any existing future booking | Pass |
| Add new booking | Superuser can add a new booking under his name  | Pass |
| **Backend**|
| Update salon information | Superuser can update information about the salon | Pass |
| Manage services list | Superuser can add, edit, or delete services offered | Pass |
| Manage groomer profiles | Superuser can add, edit, or delete groomer profiles | Pass |
 Manage groomers' schedules | Superuser can add, edit, or delete groomer schedule | Pass |
 | Manage gallery images | Superuser can add, edit, or delete images in the gallery | Pass |
| View contact form submissions | Superuser can see all contact form submissions | Pass |
| Mark contact form submission as read | Superuser can mark a submission as read | Pass |
| Delete contact form submission | Superuser can delete a submission | Pass |
| View list of users | Superuser can see a list of all registered users | Pass |
| View list of bookings | Superuser can see a list of all bookings made | Pass |
| Edit user details | Superuser can edit user details | Pass |
| Delete user | Superuser can delete a user | Pass |
| Add new user | Superuser can add a new user | Pass |
|Reset user password | Superuser can reset user password | Pass |
| Edit booking details | Superuser can edit booking details | Pass |
| Delete booking | Superuser can delete a booking | Pass |
| Add new booking | Superuser can add a new booking | Pass |

#### User Stories
| User Story | Expected Behaviour | Actual Behaviour | Status |
|------------|-------------------|----------------|-----------|
| As a Site User, I can see a welcoming message and a catchy image when I first visit the homepage so that I feel engaged and have a positive first impression of the salon. | The homepage shows a welcoming message and a catchy image upon first visit. | The homepage shows the welcoming message and the catchy image as expected. | Pass|
| As a Site User, I can view information about the salon on the homepage so that I can understand the salon's mission and background. | The homepage displays the salon's mission and background information clearly. | The homepage displays the salon's mission and background information as expected. | Pass|
| As a Site User, I can easily navigate the website through a comprehensive menu located in the header and access site pages so that I can explore the site fully and access my account. | The header menu is comprehensive, functional, and allows access to all site pages and user account. | The header menu is functional and allows access to all pages and user accounts. | Pass|
| As a Site User, I can view a list of services on the homepage so that I can quickly learn about the different grooming options available.  | The homepage lists all grooming services available, clearly and accessibly. | The homepage lists all grooming services as expected. | Pass|
| As a Site User, I can view information about the groomers on the 'Groomers' page so that I can choose a groomer based on their expertise.  | The 'Groomers' page provides information about each groomer and their expertise. | The 'Groomers' page provides information as expected. | Pass|
| As a Site User, I can view a gallery of photos on the 'Gallery' page featuring dogs in the process of being groomed or already groomed so that I can see the quality and range of grooming services offered. | The 'Gallery' page displays photos of dogs being groomed or already groomed, showcasing the quality of services. | The 'Gallery' page displays photos of dogs as expected. | Pass|
| As a Site User, I can find contact details in the footer on any page of the site so that I can reach out to the salon for further inquiries, to book an appointment, or to know the salon's location and working hours.  | Contact details are visible in the footer on every page, providing information for inquiries, booking, and location. | Contact details are visible in the footer on every page as expected. | Pass|
| As a Site User, I can access and use the contact form on the 'Contact' page so that I can send inquiries directly to the salon.  | The 'Contact' page contains a functional contact form that allows users to send inquiries directly to the salon. | The 'Contact' page contains a functional contact form, as expected. | Pass|
| As a Site Owner, I can store contact form requests in the database so that I can review them, mark them as read, or delete them.  Contact form submissions are stored in the database and can be reviewed, marked as read, or deleted by the owner.  | Contact form submissions are stored in the database and can be reviewed, marked as read, or deleted as expected. | Pass|
| As a Site Owner, I can mark contact form submissions as "read" so that I can track how many I still need to process. | The site owner can mark contact form submissions as "read" to track processing status. | Contact form submissions can be marked as "read" to track processing status as expected. | Pass|
| As a Site User, I can create an account through the Log In bar so that I can access personalised services to book and store my appointments.  | Users can create an account through the Log In bar to access personalised services and manage appointments. | Account creation through the Log In bar works as expected. | Pass|
| As a Site User, I can log in using the Log In bar so that I can easily see and manage my existing bookings or log out. | Users can log in through the Log In bar to view and manage bookings or log out. | Logging in through the Log In bar works as expected. | Pass|
| As a Site User, I can see multiple entry points to make a booking so that I can easily book a service. | Multiple entry points for booking are available throughout the site, making it easy for users to book services. | Multiple entry points for booking are available as expected. | Pass|
| As a Registered Customer, I can book an appointment so that I can groom my dog. | Registered customers can book grooming appointments through the site. | Booking an appointment works as expected. | Pass|
| As a Registered Customer, I can delete my existing booking so that I can remove an appointment I no longer need. | Registered customers can delete their existing bookings. | Deleting an existing booking works as expected. | Pass|
| As a Registered Customer, I can edit my booking appointment so that I can update or change the details of the appointment or the information I have provided.  | Registered customers can edit their existing bookings to update or change details.| Editing an existing booking works as expected. | Pass|
| As a Site Owner, I can view and manage all existing bookings in the admin panel, so that I can oversee the salon's schedule and make changes or cancel bookings when needed.  | The site owner can view and manage all bookings, including making changes or cancellations in the admin panel. | Viewing and managing all bookings through the admin panel works as expected for the site owner. | Pass|
...
**Error 1 type:** 
```
Element `p` is not allowed as a child of element span in this context. (Suppressing further errors from this subtree.)
```
...
**Error 2:** 
```
Error: No 'p' element in scope, but a 'p' end tag is seen.
```
...
The code from Summernote is causing Error 1 type and Error 2: 
...
The Sign-Up Page has resulted in a few errors:

![Sign Up Page](/media/html-validator-sign-up-page.jpeg)

This code is pulled from the all-auth package, and it was not possible to locate the HTML file where the code is stored; therefore, these errors remain unresolved due to the time limitation:

![Sign Up Page HTML Error Source](/media/html-sign-up-error-cause.jpeg)
...
However, a few days later, when checking it again by pasting the site URL, the following errors occurred:
...
Furthermore, 434 warnings were identified by the CSS Validator:

![CSS Validator Warnings](/media/css-validator-warnings.jpeg)

These warnings can be grouped into three main categories: 
...
- **Color Warnings:** State that the same colour was used for the background and border. These warnings do not affect the site intended design and, therefore, can be ignored.

![CSS Color Warnings](/media/css-color-warnings.jpeg)

When testing the CSS code through the direct input, no issues were identified:  
...
Five types of errors were identified on multiple pages:
...
- Resolution: Lines with such errors were broken into multiple lines using parentheses or string concatenation.
...
- Resolution: It was ensured that continuation lines with such errors are indented to the same level as the opening parenthesis.
...
To improve performance, it was ensured that all images used on the site were converted to WEBP format and resized. Additionally, the styles of hero images, services, gallery, and groomers' images were enhanced by adding height and width attributes to optimise cumulative layout shift.
...
However, when these same links are accessed from another page (e.g., "Groomers" or "Gallery"), clicking the links leads to the homepage as expected, the navbar folds back, and the `scroll-padding-top` is applied. This results in the targeted content appearing in the middle of the screen, rather than at the top. This behaviour affects the user experience by making the navigation seem inconsistent.

![Anchor Link Accessed Not From Home Page](/media/anchor-link-accessed-not-from-home-page.jpeg)

*Steps to Reproduce:*

1. Navigate to the homepage on a mobile device or in a narrow browser window where the navbar collapses into a hamburger menu.
...
5. Notice that after redirection and the auto-collapse of the navbar, the content appears in the middle of the screen.
...
- Code Institute ['I think Therefore I blog' Walk through](https://learn.codeinstitute.net/courses/course-v1:CodeInstitute+FSD101_WTS+2/courseware/56a2da0940b4411d8a38c2b093a22c60/4565659a34d648b8b8edd063c3182180/) was used as an inspiration and guide for creating this project.
...
- To centre the logo position in the header, the transform on the logo in the header was used: [SheCodes](https://www.shecodes.io/athena/121718-how-to-use-transform-translate-50-50-to-center-an-element-in-css121718-how-to-use-transform-translate-50-50-to-center-an-element-in-css).
...
- The text for the home page, service descriptions, and groomers' profiles was generated using [Chat GPT](https://chat.openai.com/).
...
- Grooming service images were sourced from [Freepik](https://www.freepik.com/).
- Gallery images were sourced from [Freepik](https://www.freepik.com/), [Unsplash](https://unsplash.com/) and [Vecteezy](https://www.vecteezy.com/).
