...
| Click on 'Next Step' button in the step one | A notification 'Please select an item in the list' appears in the Services dropdown list | Pass |
| Select Service from the dropdown list and click on 'Next Step' button in the step one | 'Please fill in this field' appears in the Date dropdown | Pass |
...
| Book an appointment for today after salon closing hours (after 5:30pm on weekday or after 4pm on weekend). Select Service from the dropdown list and select today's date in step one and click 'Next Step' | Error message "Not possible to book for today as the salon is already closed" is displayed | Pass |
| Select Service from the dropdown list and select a date within next 90 days and click 'Next Step' | Step two of the booking form loads with options to select a groomer. Options to go to the 'Prev Step', 'Next Step' or 'Cancel' are available | Pass |
| Click on 'Prev Step' in Step two | 'Please select an item in the list' appears in the Groomers dropdown list. After selecting a groomer, and clicking on 'Prev Step' again, user is directed back to step one with previously entered service and date details retained | Pass |
...
| Try to delete any past bookings, before today's date | Delete options for older bookings are grayed out| Pass |
...
| Click on Edit next to any future appointment. Step one of the booking form loads with the prefilled details of the appointment. In step one change 'service' and 'date', select date within next 90 days, then click 'Next Step' | Step two of the booking form loads with the prefilled groomer name (if available on that date, or the dropdown is blank). Groomer name can be changed from the dropdown. Options to go to the 'Prev step', 'Next Step' or 'Cancel' are available | Pass |
...
| Click on Edit next to any future appointment. Step one of the booking form loads with the prefilled details of the appointment. In step one change 'service' and 'date', select date within next 90 days, then click 'Next Step'. Step two of the booking form loads with the prefilled groomer name (if available on that date, or the dropdown is blank). Change/select groomer. Click on 'Next Step' in Step two | Step three of the booking form loads with the available time slots. Options to go to the 'Prev step', 'Cancel' or 'Submit' are available | Pass |
...
| Click on Edit next to any future appointment. Step one of the booking form loads with the prefilled details of the appointment. In step one change 'service' and 'date', select date within next 90 days, then click 'Next Step'. Step two of the booking form loads with the prefilled groomer name (if available on that date, or the dropdown is blank). Change/select groomer. Click on 'Next Step' in Step two. Step three of the booking form loads with the available time slots. Click on 'Cancel' in Step three | Editing is cancelled, user is directed to the All Bookings Page | Pass |
...
| As a Site User, I can easily navigate the website through a comprehensive menu located in the header and access site pages so that I can explore the site fully and access my account. | The header menu is comprehensive, functional, and allows access to all site pages and user account. | The header menu is functional and allows access to all pages and user account. | Pass|
...
| As a Site Owner, I can store contact form requests in the database so that I can review them, mark as read, or delete. | Contact form submissions are stored in the database and can be reviewed, marked as read, or deleted by the owner.  | Contact form submissions are stored in the database and can be reviewed, marked as read, or deleted as expected. | Pass|
| As a Site Owner, I can mark contact form submission as "read" so that I can track how many I still need to process. | The site owner can mark contact form submissions as "read" to track processing status. | Contact form submissions can be marked as "read" to track processing status as expected. | Pass|
...
- Code institute ['I think Therefore I blog' Walk through](https://learn.codeinstitute.net/courses/course-v1:CodeInstitute+FSD101_WTS+2/courseware/56a2da0940b4411d8a38c2b093a22c60/4565659a34d648b8b8edd063c3182180/) was used as an insipation and guide for creatign this project.
- [Bootstrap 5 documentation](https://getbootstrap.com/docs/5.3/getting-started/introduction/) was used for designing layout and styling elements of the project.
...
- Grooming services images were sourced from [Freepik](https://www.freepik.com/).
- Gallery images were source from [Freepik](https://www.freepik.com/), [Unsplash](https://unsplash.com/) and [Vecteezy](https://www.vecteezy.com/).
