...
from .views import book_appointment_step_one,  book_appointment_step_two, my_appointments, appointment_delete, edit_appointment_step_one
...
urlpatterns = [
    ...
    path('edit_appointment_step_one/', edit_appointment_step_one, name='edit_appointment_step_one'),
]